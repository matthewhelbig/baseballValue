...
First, we split our data by year:
...
Then we need to delete the duplicate values from each year, like we mentioned above:
...
Finally, we bind them back together into the dataframe that we'll be using for our batter analysis:
